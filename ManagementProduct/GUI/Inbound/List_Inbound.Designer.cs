namespace ManagementProduct.GUI.Inbound
{
    partial class List_Inbound
    {
        ...
        private void InitializeComponent()
        {
            ...
            txtSearch.Location = new Point(2117, 79);
            ...
            label2.Location = new Point(2117, 29);
            label2.Name = "label2";
            ...
            guna2DataGridView1.Columns.AddRange(new DataGridViewColumn[] { dgvNo, dgvid, dgvProduct, dgvSupplier, dgvQuantity, dgvDate, dgvEdit, dgvDel });
            ...
            guna2DataGridView1.Location = new Point(69, 192);
